...
module.exports = function(app) {
	...
	app.get('/scrapeArticles', function(req, res) {
		...
		axios
			.get('https://www.livescience.com/' + randomCriteria + '?type=article')
	...
	app.get('/articleSaved/:id', function(req, res) {
		db.Article
			.findOneAndUpdate({ _id: req.params.id }, { isSaved: true }, { new: true })
			.then(function(dbArticle) {
	...
	app.get('/deleteNote/:id', function(req, res) {
		db.Article.update({}, { $pull: { notes: req.params.id } }, function(err, numeffected) {
